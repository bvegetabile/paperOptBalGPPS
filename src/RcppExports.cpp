...
RcppExport SEXP _paperOptBalGPPS_construct_sqexp(SEXP XSEXP, SEXP MSEXP, SEXP sigSEXP, SEXP noiseSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _paperOptBalGPPS_sqexp_ard(SEXP XSEXP, SEXP hyperparamsSEXP, SEXP scaleSEXP, SEXP noiseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _paperOptBalGPPS_sqexp_common(SEXP XSEXP, SEXP lengthscaleSEXP, SEXP scaleSEXP, SEXP noiseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
...
RcppExport SEXP _paperOptBalGPPS_polykernel(SEXP XSEXP, SEXP sig_zeroSEXP, SEXP pwrSEXP, SEXP scaleSEXP, SEXP noiseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
...
RcppExport SEXP _paperOptBalGPPS_par_ep(SEXP ySEXP, SEXP cov_matrixSEXP, SEXP tolSEXP, SEXP max_itersSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _paperOptBalGPPS_seq_ep(SEXP ySEXP, SEXP cov_matrixSEXP, SEXP tolSEXP, SEXP max_itersSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type y(ySEXP);
...
RcppExport SEXP _paperOptBalGPPS_par_sqexp(SEXP design_xSEXP, SEXP vec_thetaSEXP, SEXP sig_noiseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_paperOptBalGPPS_construct_sqexp", (DL_FUNC) &_paperOptBalGPPS_construct_sqexp, 4},
    {"_paperOptBalGPPS_sqexp_ard", (DL_FUNC) &_paperOptBalGPPS_sqexp_ard, 4},
    {"_paperOptBalGPPS_sqexp_common", (DL_FUNC) &_paperOptBalGPPS_sqexp_common, 4},
    {"_paperOptBalGPPS_polykernel", (DL_FUNC) &_paperOptBalGPPS_polykernel, 5},
    {"_paperOptBalGPPS_par_ep", (DL_FUNC) &_paperOptBalGPPS_par_ep, 5},
    {"_paperOptBalGPPS_seq_ep", (DL_FUNC) &_paperOptBalGPPS_seq_ep, 5},
    {"_paperOptBalGPPS_par_sqexp", (DL_FUNC) &_paperOptBalGPPS_par_sqexp, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_paperOptBalGPPS(DllInfo *dll) {
