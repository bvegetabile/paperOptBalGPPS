...
for(i in 1:n_sims){
  ...
  bal_mats1[i, 1] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_true)[1, 7]
  bal_mats1[i, 2] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gp1)[1, 7]
  bal_mats1[i, 3] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gp2)[1, 7]
  bal_mats1[i, 4] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_bart)[1, 7]
  bal_mats1[i, 5] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gbm1)[1, 7]
  bal_mats1[i, 6] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gbm2)[1, 7]
  bal_mats1[i, 7] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gbm3)[1, 7]
  bal_mats1[i, 8] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_cbps)[1, 7]
  bal_mats1[i, 9] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_glm2)[1, 7]
  bal_mats1[i, 10] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_glm1)[1, 7]
  
  bal_mats2[i, 1] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_true)[4, 7]
  bal_mats2[i, 2] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gp1)[4, 7]
  bal_mats2[i, 3] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gp2)[4, 7]
  bal_mats2[i, 4] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_bart)[4, 7]
  bal_mats2[i, 5] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gbm1)[4, 7]
  bal_mats2[i, 6] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gbm2)[4, 7]
  bal_mats2[i, 7] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_gbm3)[4, 7]
  bal_mats2[i, 8] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_cbps)[4, 7]
  bal_mats2[i, 9] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_glm2)[4, 7]
  bal_mats2[i, 10] <- gpbalancer::bal_table(X, 1:2, TA==1, wts=wts_glm1)[4, 7]
